...
Note: This is the server-side code. To actually play Blurrdle, you'll want to try the web app at [Blurrdle.com](http://blurrdle.com) or download and run the [Java CLI client.](https://github.com/christopher-capps/blurrdle-client)
