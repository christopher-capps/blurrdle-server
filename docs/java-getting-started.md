...
import org.jscience.physics.org.christopercapps.blurrdle.model.RelativisticModel;
...
String hello(Map<String, Object> org.christopercapps.blurrdle.model) {
    RelativisticModel.select();
    Amount<Mass> m = Amount.valueOf("12 GeV").to(KILOGRAM);
    org.christopercapps.blurrdle.model.put("science", "E=mc^2: 12 GeV = " + m.toString());
    return "hello";
}
```
...
String hello(Map<String, Object> org.christopercapps.blurrdle.model) {
    ...
    org.christopercapps.blurrdle.model.put("science", "E=mc^2: " + energy + " = "  + m.toString());
    return "hello";
}
```
